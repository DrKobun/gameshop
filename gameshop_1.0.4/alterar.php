...
<?php
    ...
    $ClassGame = new ClassGame();
    $teste = $ClassGame->getPath();
...
<html>
   <head>
    ...
    <div class="container" style="display:flex">
            <form enctype="multipart/form-data" action="AlterarProcessa.php" method="POST">
                <!-- ID: -->
                ...
                <br>
                <br>
                <input type="file" name="novaImagem" style="width: 59vw;" >
                <input type="hidden" name=mesmaImagem value="<?php //echo $caminho?>">
                
                <?php echo $caminho?>
                      <img height='30px' src="<?php echo $caminho?>" alt="">
                <br>
                <br>
